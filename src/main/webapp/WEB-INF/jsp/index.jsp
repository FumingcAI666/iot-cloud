                ...
                <div class="row-fluid">
                    ...
                    <div class="span3 responsive" data-tablet="span6" data-desktop="span3">
                        <div class="dashboard-stat green">
                            ...
                            <div class="details">
                                <div class="number"> ${qcount} </div>
                                <div class="desc">设备总数</div>
                            </div>
                            <a class="more" href="/equipment_list">
                                View more <i class="m-icon-swapright m-icon-white"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="span3 responsive" data-tablet="span6  fix-offset" data-desktop="span3">
                        <div class="dashboard-stat purple">
                            ...
                            <div class="details">
                                <div class="number"> ${mcount}</div>
                                <div class="desc">数据流模板</div>
                            </div>
                            <a class="more" href="/dataStreamModes">
                                View more <i class="m-icon-swapright m-icon-white"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="span3 responsive" data-tablet="span6" data-desktop="span3">
                        <div class="dashboard-stat yellow">
                            ...
                            <div class="details">
                                <div class="number"> ${ecount} </div>
                                <div class="desc">数据信息</div>
                            </div>
                            <a class="more" href="/entity_info">
                                View more <i class="m-icon-swapright m-icon-white"></i>
                            </a>
                        </div>
                    </div>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <c:forEach items="${productlist}" var="row">
                                        <tr>
                                            ...
                                            <td>${row.id}</td>
                                            <td>
                                                <a href="/equipment_infrom?pid=${row.id}&name=${row.name}">${row.name}</a>
                                            </td>
                                            <td>${row.industry}</td>
                                            <td>${row.category}</td>
