                ...
                <div class="span12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->${msg}
                            <form action="/equipment_updatas" class="form-horizontal">
                                <div class="control-group">
                                    <div class="controls">
                                        <input type="hidden" class="span6 m-wrap" name="id" value="${equipment.id}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">设备名</label>
                                    <div class="controls">
                                        <input type="text" class="span6 m-wrap" name="name" value="${equipment.name}"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">设备编号</label>
                                    <div class="controls">
                                        <input type="text" class="span6 m-wrap" name="code" value="${equipment.code}"/>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 m-wrap" name="describe" value="${equipment.describe}"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">设备状态0/1</label>
                                    <div class="controls">
                                        <input type="text" class="span6 m-wrap" name="state" value="${equipment.state}"/>
                                    </div>
                                </div>
