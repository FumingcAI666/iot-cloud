                        ...
                        <div class="portlet-body form">
                            ...
                            <form action="/update_user" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span6 m-wrap" type="text" name="phone" value="${user.phone}"
                                               disabled/>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span6 m-wrap" type="text" name="password"
                                               value="${user.password}"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 m-wrap popovers" name="email"
                                               value="${user.email}" data-trigger="hover" data-content="请输入正确邮箱以便验证"
                                               data-original-title="提升"/>
                                    </div>
                                </div>
