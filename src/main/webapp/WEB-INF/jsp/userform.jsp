                ...
                <div class="span12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i> 个 人 信 息 </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form action="/update_user" class="form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 m-wrap" name="name" value="${user.name}"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">手机号码</label>
                                    <div class="controls">
                                        <input class="span6 m-wrap" type="text" name="phone" value="${user.phone}" disabled />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span6 m-wrap" type="text" name="password" value="${user.password}"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">邮箱</label>
                                    <div class="controls">
                                        <input type="text" class="span6 m-wrap popovers" name="email" value="${user.email}" data-trigger="hover" data-content="请输入正确邮箱以便验证" data-original-title="提升" />
                                    </div>
                                </div>
